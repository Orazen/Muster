...
2. Register the bundle ID `com.muster.companion` (or change it in `project.yml` before the first upload).
3. Create the matching app in App Store Connect with the name **Muster Mobile**, primary category **Productivity**, and a unique SKU.
...
- Support URL: `https://github.com/tharunramagiri/Muster/issues`
