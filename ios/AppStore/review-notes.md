...
MusterMobile is a companion for the Muster desktop application and does not use a developer-hosted login.

To review the app:

1. Install and start Muster on a Mac, Windows, or Linux computer.
