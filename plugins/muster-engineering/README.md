...
4. **Outerloop** (`outerloop`) — Evidence (1113 lint + 56 security findings) → Verdict (all mechanical fixes approved / false positives resolved) → Answerability (commit `225ae54` + `docs/audits/audit-strategy-2026-08.md`)
