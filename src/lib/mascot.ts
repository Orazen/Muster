...
export { AGENT_CHARACTERS, type AgentCharacter } from "../../server/agent-character";
...
} satisfies Record<string, AgentState[]>;
...
export type AgentMotion = "none" | (typeof AGENT_MOTIONS)[number];
...
const KNOWN_STATES = new Set<string>(AGENT_STATES);
 ...
 */
export const PICKABLE_STATES: AgentState[] = [
  "idle", // expression 0
  "happy", // 2
  "curious", // 3
  "drowsy", // 4
 ...
 */
export function stateForBot(bot: MascotBotProfile): AgentState {
