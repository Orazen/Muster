 ...
 *
 * Renders nothing when the server has no providers configured — a button that
 * always errors is worse than an absent one, and providers are opt-in per
 * deployment via env vars.
 */
export function SocialSignIn({ action = "Sign in" }: { action?: string }) {
