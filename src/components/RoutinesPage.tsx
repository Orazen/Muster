      ...
      <div className="max-h-[90vh] w-full max-w-[620px] overflow-y-auto rounded-2xl border border-hairline/60 bg-panel shadow-2xl">
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-hairline/40 bg-panel/95 px-5 py-4 backdrop-blur">
          <div>
            ...
            <div className="mt-0.5 text-[12px] text-ink-secondary">Give a AGENT scheduled work with a calendar you can trust.</div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              >
                ...
                <div className="mt-1 text-[11px] leading-relaxed text-ink-secondary">Uses this AGENT's selected model and computer setting.</div>
              </button>
              <button
                type="button"
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-[12.5px] text-ink-secondary">{section === "calendar" ? "Run AGENT tasks on a schedule." : "Run AGENT tasks when an event arrives."}</p>
          </div>
