/**
 * Adapted from GAIA UI WaveSpinner, Copyright (c) 2026 The Experience Company.
 * Source: https://github.com/theexperiencecompany/gaia-ui/blob/14e20153ff1fa89897e2e90aa13eb17c69d4b156/registry/new-york/ui/wave-spinner.tsx
 ...
 * Adaptations: import path (cn from @/lib/cn); the "primary" preset follows
 * Muster's skin-aware accent token instead of GAIA blue; a .wave-spinner class
 * scopes the reduced-motion rule to this component.
 */
...
// Color presets — "primary" rides Muster's skin-aware accent token.
const COLOR_PRESETS = {
  /** the app accent, per active skin */
...
const waveSpinnerVariants = cva("wave-spinner flex items-center justify-center w-fit", {
  variants: {
    size: {
