              ...
              <div className="flex flex-wrap items-start justify-between gap-3 px-5 pt-5 md:px-7 md:pt-6">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-1.5 text-[10.5px] text-ink-secondary"><span>{selectedBot?.name ?? "Deleted AGENT"}</span><span>·</span><span>{selected.runOn === "cloud" ? "Cloud VM" : selected.runOn === "opensandbox" ? "OpenSandbox" : "This computer"}</span></div>
                  </div>
                </div>
                <div className="flex items-center gap-2">
