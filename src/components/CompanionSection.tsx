...
export function CompanionSection() {
  ...
  if (!bridge()) {
    return (
      <Card
        title="Companion"
        subtitle="The companion runs as its own process, which only the desktop app can start. Open Muster on this computer to turn it on."
      >
        <div />
      </Card>
    );
      ...
      >
        ...
        {state.enabled && state.tailscale && !state.tailnetName && (
          <div className="mt-3 text-[13px] text-ink-secondary">
            ...
            Muster log for which paths were tried.
          </div>
        )}
