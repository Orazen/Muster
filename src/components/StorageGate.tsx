    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/60 p-4" role="dialog" aria-modal="true" aria-label="Connect your storage">
      <div className="w-full max-w-md rounded-2xl bg-card p-7 text-ink shadow-2xl">
        ...
        <h1 className="text-xl font-semibold text-ink">
          {driveAvailable ? "Connect your Google Drive" : "Storage setup isn't available yet"}
        </h1>
        <p className="mt-3 text-[13.5px] leading-relaxed text-ink-secondary">
          {driveAvailable
            ...
            : "This Muster deployment has no Google Drive credentials configured, so there is no way to connect Drive from here yet. Your workspace is still stored on Muster’s server and nothing has been lost — ask the person who runs this server to add Drive credentials, or connect from the desktop app."}
        </p>
        {driveAvailable && (
          <button
