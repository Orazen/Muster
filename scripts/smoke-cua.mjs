...
process.env.MUSTER_CUA_SDK_LIBRARY = join(resources, "cua-sdk/native/libcua_driver_sdk.dylib");
...
const host = new EmbeddedCuaDriverHost(binary, "com.muster.app");
let proxy;
...
try {
  ...
  proxy = spawn(connection.mcp.command, connection.mcp.args, {
    env: {
      ...
      CUA_DRIVER_HOST_BUNDLE_ID: "com.muster.app",
  ...
  await rpc("initialize", {
    ...
    capabilities: {},
    clientInfo: { name: "muster-package-smoke", version: "1" },
  });
